            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm border-custom mt-2">
                    ...
                    <?php elseif($_SESSION['role'] === 'capital_risque'): ?>
                        <li><a class="dropdown-item py-2" href="<?= URLROOT ?>/investor/dashboard"><i class="fa-solid fa-wallet me-2 text-muted-custom"></i>Tableau de bord</a></li>
                    <?php elseif($_SESSION['role'] === 'admin'): ?>
                        <li><a class="dropdown-item py-2" href="<?= URLROOT ?>/admin/dashboard"><i class="fa-solid fa-shield-halved me-2 text-muted-custom"></i>Administration</a></li>
                    <?php endif; ?>
                    <li><hr class="dropdown-divider border-custom"></li>
                    <li><a class="dropdown-item py-2 text-danger" href="<?= URLROOT ?>/auth/logout"><i class="fa-solid fa-arrow-right-from-bracket me-2"></i>Déconnexion</a></li>
                </ul>
            </li>
        <?php else: ?>
            <li class="nav-item me-2">
                <a class="nav-link fw-medium" href="<?= URLROOT ?>/auth/login">Connexion</a>
            </li>
            <li class="nav-item">
                <a class="btn btn-primary px-4 py-2 shadow-sm" href="<?= URLROOT ?>/auth/registerInvestor">Créer un compte</a>
            </li>
        <?php endif; ?>
